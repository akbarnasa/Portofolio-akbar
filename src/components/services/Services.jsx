  ...
  return (
    <section className="bg-secondary dark:bg-gray-900 dark:text-white py-10">
      <div className="container flex flex-col items-center">
        ...
        Saya membantu mengerjakan desain, pengembangan web, pengelolaan dokumen, 
        serta troubleshooting perangkat agar aktivitas kerja kamu lebih mudah dan efisien
        </p>
      </div>
      <div>
        <ServicesBox />
